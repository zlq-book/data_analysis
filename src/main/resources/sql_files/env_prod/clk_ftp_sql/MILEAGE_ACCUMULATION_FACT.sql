...
INSERT INTO DWD_PROD.T_DWD_CLK_MILEAGE_ACCUMULATION_FACT
(
    PK_ID,
    DATE,
    AIRLINE_NAME,
...
FROM ODS_PROD.T_ODS_CLK_MILEAGE_ACCUMULATION AS ods
LEFT JOIN DWD_PROD.T_DWD_CLK_MILEAGE_ACCUMULATION_FACT AS dwd
