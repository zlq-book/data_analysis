...
INSERT INTO DWD_PROD.T_DWD_CLK_MEMBER_DEVELOPMENT_FACT
(
    PK_ID,
    DATE,
    AIR_CHINA,
...
FROM ODS_PROD.T_ODS_CLK_MEMBER_DEVELOPMENT AS ods
LEFT JOIN DWD_PROD.T_DWD_CLK_MEMBER_DEVELOPMENT_FACT AS dwd
