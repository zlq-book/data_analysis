...
INSERT INTO DWD_PROD.T_DWD_CLK_MEMBER_UPGRADE_FACT
(
    PK_ID,
    DATE,
    AIRLINE_NAME,
...
FROM ODS_PROD.T_ODS_CLK_MEMBER_UPGRADE AS ods
LEFT JOIN DWD_PROD.T_DWD_CLK_MEMBER_UPGRADE_FACT AS dwd
