...
FROM DWD_TEST.T_DWD_REFUND_SEG_FACT t1
         left join DWD_TEST.T_DWD_TICKING_SEG_FACT t2
...
FROM DWD_TEST.T_DWD_DATECHANGE_SEG_FACT datechange
         LEFT JOIN DWD_TEST.T_DWD_TICKING_SEG_FACT seg ON (
