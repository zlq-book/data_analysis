...
INSERT INTO DWD_TEST.T_DWD_CLK_VIP_MEMBER_TOTAL_FACT
(
    PK_ID,
    DATE,
    NAME,
...
FROM ODS_TEST.T_ODS_CLK_VIP_MEMBER_TOTAL AS ods
LEFT JOIN DWD_TEST.T_DWD_CLK_VIP_MEMBER_TOTAL_FACT AS dwd
