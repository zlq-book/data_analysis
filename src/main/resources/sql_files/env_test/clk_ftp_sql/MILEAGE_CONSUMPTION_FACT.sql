...
INSERT INTO DWD_TEST.T_DWD_CLK_MILEAGE_CONSUMPTION_FACT
(
    PK_ID,
    DATE,
    AIRLINE_NAME,
...
FROM ODS_TEST.T_ODS_CLK_MILEAGE_CONSUMPTION AS ods
LEFT JOIN DWD_TEST.T_DWD_CLK_MILEAGE_CONSUMPTION_FACT AS dwd
