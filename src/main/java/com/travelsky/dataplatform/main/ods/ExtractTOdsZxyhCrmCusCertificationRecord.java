 ...
 * @date 2025/7/2 9:31
 */
public class ExtractTOdsZxyhCrmCusCertificationRecord {
    public static void main(String[] args) throws IOException {
        ...
        //checkpoint设置
//        CheckpointUtils.setCheckpoint(env, "ExtractTOdsZxyhCrmCusCertificationRecord");
...
//创建上游数据源表
        tEnv.executeSql("CREATE TABLE CRM_CUS_CERTIFICATION_RECORD (\n" +
                "ID VARCHAR(96) ,\n" +
                ...
                "CERTIFICATION_TYPE VARCHAR(6) ,\n" +
                "CERTIFICATION_STATUS VARCHAR(6) ,\n" +
                "UNIONCARD_NUMBER VARCHAR(300),\n" +
                "REGIST_CHANNEL VARCHAR(30) ,\n" +
                "CERTIFICATION_REMARK VARCHAR(12000) ,\n" +
                "FIRST_CN_NAME VARCHAR(200) ,\n" +
                "LAST_CN_NAME VARCHAR(200)\n" +
                ") WITH (\n" +
                "    'connector' = 'jdbc',\n" +
                "    'url' = 'jdbc:oracle:thin:@//"+Constants.ZXYH_IP+":"+Constants.ZXYH_PORT+"/"+Constants.ZXYH_DB+"',\n" +
                "    'table-name' = '"+Constants.ZXYH_SCHEMA+".CRM_CUS_CERTIFICATION_RECORD', \n" +
                "    'username' = '"+Constants.ZXYH_USER+"',\n" +
                "    'password' = '"+Constants.ZXYH_PWD+"'\n" +
                ",\n" + "  'driver' = '"+Constants.ORACLE_DRIVER+"'" +
                ")");
        //创建Doris目标表
        tEnv.executeSql("CREATE TABLE T_ODS_ZXYH_CRM_CUS_CERTIFICATION_RECORD (\n" +
                "    ETL_DATE DATE,\n" +
                "ID VARCHAR(96) ,\n" +
                "CUSTOMER_ID VARCHAR(96) ,\n" +
                "CN_NAME VARCHAR(600) ,\n" +
                ...
                " 'table.identifier' = '" + Constants.ODS_DB + ".T_ODS_ZXYH_CRM_CUS_CERTIFICATION_RECORD',\n" +
        ...
        String extractSql = "INSERT INTO T_ODS_ZXYH_CRM_CUS_CERTIFICATION_RECORD(" +
                "ETL_DATE,\n" +
                "ID,\n" +
                "CUSTOMER_ID,\n" +
                "CN_NAME,\n" +
                ...
                "FIRST_CN_NAME,\n" +
                "LAST_CN_NAME\n" +
                " FROM CRM_CUS_CERTIFICATION_RECORD "
