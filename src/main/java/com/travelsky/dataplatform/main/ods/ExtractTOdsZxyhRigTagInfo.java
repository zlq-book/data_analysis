 ...
 * @date 2025/7/2 9:31
 */
public class ExtractTOdsZxyhRigTagInfo {
    public static void main(String[] args) throws IOException {
        ...
        //checkpoint设置
        CheckpointUtils.setCheckpoint(env, "ExtractTOdsZxyhRigTagInfo");
...
//创建上游数据源表
        tEnv.executeSql("CREATE TABLE RIG_TAG_INFO (\n" +
                "ID VARCHAR(96) ,\n" +
                "TAG_NAME VARCHAR(96) ,\n" +
                "TAG_CODE VARCHAR(96) ,\n" +
                "TAG_LEVEL VARCHAR(96) ,\n" +
                "TAG_STATUS CHAR(10) ,\n" +
                "ENABLE CHAR(10) ,\n" +
                ...
                "    'table-name' = '"+Constants.ZXYH_SCHEMA+".RIG_TAG_INFO', \n" +
                "    'username' = '"+Constants.ZXYH_USER+"',\n" +
                "    'password' = '"+Constants.ZXYH_PWD+"'\n" +
                ",\n" + "  'driver' = '"+Constants.ORACLE_DRIVER+"'" +
                ")");
        //创建Doris目标表
        tEnv.executeSql("CREATE TABLE T_ODS_ZXYH_RIG_TAG_INFO (\n" +
                "    ETL_DATE DATE,\n" +
                "ID VARCHAR(96) ,\n" +
                "TAG_NAME VARCHAR(96) ,\n" +
                "TAG_CODE VARCHAR(96) ,\n" +
                ...
                " 'table.identifier' = '" + Constants.ODS_DB + ".T_ODS_ZXYH_RIG_TAG_INFO',\n" +
        ...
        String extractSql = "INSERT INTO T_ODS_ZXYH_RIG_TAG_INFO(" +
                "ETL_DATE,\n" +
                "ID,\n" +
                "TAG_NAME,\n" +
                "TAG_CODE,\n" +
