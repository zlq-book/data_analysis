 ...
 * @date 2025/7/2 9:31
 */
public class ExtractTOdsZxyhCrmCusFamilyCertInfo {
    public static void main(String[] args) throws IOException {
        ...
        //checkpoint设置
        CheckpointUtils.setCheckpoint(env, "ExtractTOdsZxyhCrmCusFamilyCertInfo");
...
//创建上游数据源表
        tEnv.executeSql("CREATE TABLE CRM_CUS_FAMILY_CERT_INFO (\n" +
                "ID VARCHAR(96) ,\n" +
                ...
                "    'table-name' = '"+Constants.ZXYH_SCHEMA+".CRM_CUS_FAMILY_CERT_INFO', \n" +
                "    'username' = '"+Constants.ZXYH_USER+"',\n" +
                "    'password' = '"+Constants.ZXYH_PWD+"'\n" +
                ",\n" + "  'driver' = '"+Constants.ORACLE_DRIVER+"'" +
                ")");
        //创建Doris目标表
        tEnv.executeSql("CREATE TABLE T_ODS_ZXYH_CRM_CUS_FAMILY_CERT_INFO (\n" +
                "    ETL_DATE DATE,\n" +
                "ID VARCHAR(96) ,\n" +
                "FAMILY_ID VARCHAR(96) ,\n" +
                "REAL_NAME_FLAG CHAR(1) ,\n" +
                ...
                " 'table.identifier' = '" + Constants.ODS_DB + ".T_ODS_ZXYH_CRM_CUS_FAMILY_CERT_INFO',\n" +
        ...
        String extractSql = "INSERT INTO T_ODS_ZXYH_CRM_CUS_FAMILY_CERT_INFO(" +
                "ETL_DATE,\n" +
                "ID,\n" +
                "FAMILY_ID,\n" +
                "REAL_NAME_FLAG,\n" +
