 ...
 * 近一年数据
 */
public class ExtractTOdsLygjDepartPassengerInfo {
    static final Logger logger = LoggerFactory.getLogger(ExtractTOdsLygjDepartPassengerInfo.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        //checkpoint设置
        CheckpointUtils.setCheckpoint(env, "ExtractTOdsLygjDepartPassengerInfo");
        ...
        //创建上游ORACLE数据源表
        tEnv.executeSql("CREATE TABLE DEPART_PASSENGER_INFO (\n" +
                "  IDX BIGINT,\n" +
                ...
                "    'table-name' = '" + Constants.LYGJ_SCHEMA + ".DEPART_PASSENGER_INFO',\n" +
        ...
        String extractSql = "INSERT INTO T_ODS_LYGJ_DEPART_PASSENGER_INFO (" +
                ...
                "  sm4_encrypt(aes_decrypt(ET, '" + Constants.LYGJ_AES_KEY + "'), '" + Constants.SM4_KEY + "') ET, \n" +
                "  ET_NUM,\n" +
                "  sm4_encrypt(aes_decrypt(ET_ID_NUM, '" + Constants.LYGJ_AES_KEY + "'), '" + Constants.SM4_KEY + "') ET_ID_NUM, \n" +
                ...
                "  PIL ,\n" +
                "  PCTC ,\n" +
                "  sm4_encrypt(aes_decrypt(PSPT, '" + Constants.LYGJ_AES_KEY + "'), '" + Constants.SM4_KEY + "') AS PSPT, " +
                "  HOSTNBR ,\n" +
                "  BRD_NO ,\n" +
                "  CKI_TIME ,\n" +
                "  CKI_AGENT ,\n" +
                ...
                "  EDIWARN ,\n" +
                "  EDIMARK,\n" +
                "  sm4_encrypt(aes_decrypt(RELATION, '" + Constants.LYGJ_AES_KEY + "'), '" + Constants.SM4_KEY + "') RELATION, \n" +
                "  BAGTAG ,\n" +
                "  FILE_NAME ,\n" +
                "  ORIG_CNNAME ,\n" +
                "  IN_FLT_NUM ,\n" +
                ...
                "  STAR_FFP_NO ,\n" +
                "  LAST_FQTV_LEVEL ,\n" +
                "  sm4_encrypt(aes_decrypt(TEL_NUM, '" + Constants.LYGJ_AES_KEY + "'), '" + Constants.SM4_KEY + "') TEL_NUM, \n" +
                "  SUID ,\n" +
                "  FQTV_DETAIL_LEVEL ,\n" +
                "  MDM_GENDER ,\n" +
                "  sm4_encrypt(aes_decrypt(CERT_NO, '" + Constants.LYGJ_AES_KEY + "'), '" + Constants.SM4_KEY + "') CERT_NO, \n" +
                "  SPECIAL_SERVICE ,\n" +
                "  SPECIAL_TAG ,\n" +
                "  IS_VVIP ,\n" +
                "  IS_CHILD ,\n" +
                ...
                "  ACTION_CODE ,\n" +
                "  ID_TYPE ,\n" +
                "  sm4_encrypt(aes_decrypt(ID_INFO, '" + Constants.LYGJ_AES_KEY + "'), '" + Constants.SM4_KEY + "') ID_INFO, \n" +
                "  MC_FLT ,\n" +
                "  PRE_SEG ,\n" +
                "  NEXT_SEG ,\n" +
                "  IO_FLAG ,\n" +
                ...
                "  LKT_IDX,\n" +
                "  LKT_STATUS ,\n" +
                "  sm4_encrypt(aes_decrypt(MOBILES, '" + Constants.LYGJ_AES_KEY + "'), '" + Constants.SM4_KEY + "') MOBILES, \n" +
                "  sm4_encrypt(aes_decrypt(TELEPHONE, '" + Constants.LYGJ_AES_KEY + "'), '" + Constants.SM4_KEY + "') TELEPHONE, \n" +
                "  LKT_UPTIME,\n" +
                "  CKI_STATUS,\n" +
                "  COUPON_STATUS,\n" +
                "  ORIGINALTKNE ,\n" +
                ...
                "  IATA_CODE,\n" +
                "  ISSUE_COUNTRY,\n" +
                "  sm4_encrypt(aes_decrypt(SSR_INFO, '" + Constants.LYGJ_AES_KEY + "'), '" + Constants.SM4_KEY + "') SSR_INFO, \n" +
                "  CKI_CITY,\n" +
                "  TCHB,\n" +
                "  PETC_BAGS,\n" +
                "  PETC_BAGWGT,\n" +
                ...
                "  FARE_BASIS_CODE,\n" +
                "  IS_PETC,\n" +
                "  sm4_encrypt(aes_decrypt(EMAIL, '" + Constants.LYGJ_AES_KEY + "'), '" + Constants.SM4_KEY + "') EMAIL \n" +
                " FROM DEPART_PASSENGER_INFO "
                //+ " WHERE  CREATE_TIME BETWEEN TIMESTAMP '2025-08-09 00:00:00' AND TIMESTAMP '2025-09-09 23:59:59.999' " +
                //" OR  UPDATE_TIME BETWEEN TIMESTAMP '2025-08-09 00:00:00' AND TIMESTAMP '2025-09-09 23:59:59.999' "
                //;
