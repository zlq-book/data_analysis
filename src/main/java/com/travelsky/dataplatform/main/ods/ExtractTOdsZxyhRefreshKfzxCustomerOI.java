 ...
 * @date 2025/7/2 9:31
 */
public class ExtractTOdsZxyhRefreshKfzxCustomerOI {
    public static void main(String[] args) throws IOException {
        ...
        //checkpoint设置
        CheckpointUtils.setCheckpoint(env, "ExtractTOdsZxyhRefreshKfzxCustomerOI");
...
//创建上游数据源表
        tEnv.executeSql("CREATE TABLE REFRESH_KFZX_CUSTOMER_O_I (\n" +
                "ID VARCHAR(96) ,\n" +
                "CUSTOMER_ID VARCHAR(96) ,\n" +
                "SYS_ID VARCHAR(600) ,\n" +
                "OPEN_ID VARCHAR(600) ,\n" +
                "UNION_ID VARCHAR(600) ,\n" +
                ...
                "    'table-name' = '"+Constants.ZXYH_SCHEMA+".REFRESH_KFZX_CUSTOMER_O_I', \n" +
                "    'username' = '"+Constants.ZXYH_USER+"',\n" +
                "    'password' = '"+Constants.ZXYH_PWD+"'\n" +
                ",\n" + "  'driver' = '"+Constants.ORACLE_DRIVER+"'" +
                ")");
        //创建Doris目标表
        tEnv.executeSql("CREATE TABLE T_ODS_ZXYH_REFRESH_KFZX_CUSTOMER_O_I (\n" +
                "    ETL_DATE DATE,\n" +
                "ID VARCHAR(96) ,\n" +
                "CUSTOMER_ID VARCHAR(96) ,\n" +
                "SYS_ID VARCHAR(600) ,\n" +
                ...
                " 'table.identifier' = '" + Constants.ODS_DB + ".T_ODS_ZXYH_REFRESH_KFZX_CUSTOMER_O_I',\n" +
        ...
        String extractSql = "INSERT INTO T_ODS_ZXYH_REFRESH_KFZX_CUSTOMER_O_I(" +
                "ETL_DATE,\n" +
                "ID,\n" +
                "CUSTOMER_ID,\n" +
                "SYS_ID,\n" +
                ...
                "UPDATE_USER,\n" +
                "REFRESH_FLAG\n" +
                " FROM REFRESH_KFZX_CUSTOMER_O_I "
