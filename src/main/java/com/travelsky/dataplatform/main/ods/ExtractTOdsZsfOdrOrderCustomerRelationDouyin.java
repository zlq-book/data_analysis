...
public class ExtractTOdsZsfOdrOrderCustomerRelationDouyin {
    public static void main(String[] args) throws IOException {
        ...
        //checkpoint设置
        CheckpointUtils.setCheckpoint(env, "ExtractTOdsZsfOdrOrderCustomerRelationDouyin");
        ...
        //创建上游ORACLE数据源表
        tEnv.executeSql("CREATE TABLE ODR_ORDER_CUSTOMER_RELATION_DOUYIN (\n" +
                "    ID VARCHAR(96) NOT NULL,\n" +
                "    MAIN_ORDER_ID VARCHAR(96),\n" +
                "    MAIN_ORDER_NO VARCHAR(96),\n" +
                "    CUSTOMER_ID VARCHAR(96),\n" +
                "    CUSTOMER_NAME VARCHAR(384),\n" +
                "    CUSTOMER_MOBILE VARCHAR(384),\n" +
                "    IS_REAL_NAME CHAR(1),\n" +
                "    CONTACTS_MOBILE VARCHAR(384),\n" +
                "    CONTACTS_NAME VARCHAR(384),\n" +
                "    CONTACTS_EMAIL VARCHAR(384),\n" +
                "    OPEN_ID VARCHAR(192),\n" +
                ...
                "    'table-name' = 'ODR_ORDER_CUSTOMER_RELATION_DOUYIN', \n" +
        ...
        String ZSF_ODR_ORDER_CUSTOMER_RELATION_DOUYIN = "CREATE TABLE T_ODS_ZSF_ODR_ORDER_CUSTOMER_RELATION_DOUYIN (\n" +
...
//                ")";
                ...
                " 'table.identifier' = '" + Constants.ODS_DB + ".T_ODS_ZSF_ODR_ORDER_CUSTOMER_RELATION_DOUYIN',\n" +
                ...
                "    'password' = '" + Constants.ODS_PWD + "'\n" +
                ")";
        tEnv.executeSql(ZSF_ODR_ORDER_CUSTOMER_RELATION_DOUYIN);

        String extractSql = "INSERT INTO T_ODS_ZSF_ODR_ORDER_CUSTOMER_RELATION_DOUYIN(" +
                "ETL_DATE\n" +
                ",ID\n" +
                ",MAIN_ORDER_ID\n" +
                ",MAIN_ORDER_NO\n" +
                ...
                ",UPDATE_TIME\n" +
                ",UPDATE_USER " +
                " FROM ODR_ORDER_CUSTOMER_RELATION_DOUYIN "
