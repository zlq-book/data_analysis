 ...
 * @date 2025/7/2 9:31
 */
public class ExtractTOdsZxyhRigGoldAccount {
    public static void main(String[] args) throws IOException {
        ...
        //checkpoint设置
        CheckpointUtils.setCheckpoint(env, "ExtractTOdsZxyhRigGoldAccount");
...
//创建上游数据源表
        tEnv.executeSql("CREATE TABLE RIG_GOLD_ACCOUNT (\n" +
                "ID VARCHAR(96) ,\n" +
                ...
                "    'table-name' = '"+Constants.ZXYH_SCHEMA+".RIG_GOLD_ACCOUNT', \n" +
                "    'username' = '"+Constants.ZXYH_USER+"',\n" +
                "    'password' = '"+Constants.ZXYH_PWD+"'\n" +
                ",\n" + "  'driver' = '"+Constants.ORACLE_DRIVER+"'" +
                ")");
        //创建Doris目标表
        tEnv.executeSql("CREATE TABLE T_ODS_ZXYH_RIG_GOLD_ACCOUNT (\n" +
                "    ETL_DATE DATE,\n" +
                "ID VARCHAR(96) ,\n" +
                "CUSTOMER_ID VARCHAR(600) ,\n" +
                "BALANCE BIGINT ,\n" +
                ...
                " 'table.identifier' = '" + Constants.ODS_DB + ".T_ODS_ZXYH_RIG_GOLD_ACCOUNT',\n" +
        ...
        String extractSql = "INSERT INTO T_ODS_ZXYH_RIG_GOLD_ACCOUNT(" +
                "ETL_DATE,\n" +
                "ID,\n" +
                "CUSTOMER_ID,\n" +
                "BALANCE,\n" +
