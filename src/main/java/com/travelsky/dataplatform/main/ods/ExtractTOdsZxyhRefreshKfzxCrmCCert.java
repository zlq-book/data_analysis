 ...
 * @date 2025/7/2 9:31
 */
public class ExtractTOdsZxyhRefreshKfzxCrmCCert {
    public static void main(String[] args) throws IOException {
        ...
        //checkpoint设置
        CheckpointUtils.setCheckpoint(env, "ExtractTOdsZxyhRefreshKfzxCrmCCert");
...
//创建上游数据源表
        tEnv.executeSql("CREATE TABLE REFRESH_KFZX_CRM_C_CERT (\n" +
                "ID VARCHAR(96) ,\n" +
                ...
                "    'table-name' = '"+Constants.ZXYH_SCHEMA+".REFRESH_KFZX_CRM_C_CERT', \n" +
                "    'username' = '"+Constants.ZXYH_USER+"',\n" +
                "    'password' = '"+Constants.ZXYH_PWD+"'\n" +
                ",\n" + "  'driver' = '"+Constants.ORACLE_DRIVER+"'" +
                ")");
        //创建Doris目标表
        tEnv.executeSql("CREATE TABLE T_ODS_ZXYH_REFRESH_KFZX_CRM_C_CERT (\n" +
                "    ETL_DATE DATE,\n" +
                "ID VARCHAR(96) ,\n" +
                "CUSTOMER_ID VARCHAR(96) ,\n" +
                "REAL_NAME_FLAG VARCHAR(30) ,\n" +
                ...
                " 'table.identifier' = '" + Constants.ODS_DB + ".T_ODS_ZXYH_REFRESH_KFZX_CRM_C_CERT',\n" +
        ...
        String extractSql = "INSERT INTO T_ODS_ZXYH_REFRESH_KFZX_CRM_C_CERT(" +
                "ETL_DATE,\n" +
                "ID,\n" +
                "CUSTOMER_ID,\n" +
                "REAL_NAME_FLAG,\n" +
