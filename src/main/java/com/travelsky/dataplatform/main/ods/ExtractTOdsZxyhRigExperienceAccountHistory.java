 ...
 * @date 2025/7/2 9:31
 */
public class ExtractTOdsZxyhRigExperienceAccountHistory {
    public static void main(String[] args) throws IOException {
        ...
        //checkpoint设置
        CheckpointUtils.setCheckpoint(env, "ExtractTOdsZxyhRigExperienceAccountHistory");
...
//创建上游数据源表
        tEnv.executeSql("CREATE TABLE RIG_EXPERIENCE_ACCOUNT_HISTORY (\n" +
                "ID VARCHAR(96) ,\n" +
                ...
                "    'table-name' = '"+Constants.ZXYH_SCHEMA+".RIG_EXPERIENCE_ACCOUNT_HISTORY', \n" +
                "    'username' = '"+Constants.ZXYH_USER+"',\n" +
                "    'password' = '"+Constants.ZXYH_PWD+"'\n" +
                ",\n" + "  'driver' = '"+Constants.ORACLE_DRIVER+"'" +
                ")");
        //创建Doris目标表
        tEnv.executeSql("CREATE TABLE T_ODS_ZXYH_RIG_EXPERIENCE_ACCOUNT_HISTORY (\n" +
                "    ETL_DATE DATE,\n" +
                "ID VARCHAR(96) ,\n" +
                "CUSTOMER_ID VARCHAR(600) ,\n" +
                "ACCOUNT_ID VARCHAR(600) ,\n" +
                ...
                " 'table.identifier' = '" + Constants.ODS_DB + ".T_ODS_ZXYH_RIG_EXPERIENCE_ACCOUNT_HISTORY',\n" +
        ...
        String extractSql = "INSERT INTO T_ODS_ZXYH_RIG_EXPERIENCE_ACCOUNT_HISTORY(" +
                "ETL_DATE,\n" +
                "ID,\n" +
                "CUSTOMER_ID,\n" +
                "ACCOUNT_ID,\n" +
                ...
                "CON_SIGN_DAYS,\n" +
                "NODE_DAY\n" +
                " FROM RIG_EXPERIENCE_ACCOUNT_HISTORY "
