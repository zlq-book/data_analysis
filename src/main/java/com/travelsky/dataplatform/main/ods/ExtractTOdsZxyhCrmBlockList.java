 ...
 * @date 2025/7/2 9:31
 */
public class ExtractTOdsZxyhCrmBlockList {
    public static void main(String[] args) throws IOException {
        ...
        //checkpoint设置
        CheckpointUtils.setCheckpoint(env, "ExtractTOdsZxyhCrmBlockList");
...
//创建上游数据源表
        tEnv.executeSql("CREATE TABLE CRM_BLOCKLIST (\n" +
                "    ID VARCHAR(96),\n" +
                "    TYPE VARCHAR(6),\n" +
                ...
                "    'table-name' = '"+Constants.ZXYH_SCHEMA+".CRM_BLOCKLIST', \n" +
                "    'username' = '"+Constants.ZXYH_USER+"',\n" +
                "    'password' = '"+Constants.ZXYH_PWD+"'\n" +
                ",\n" + "  'driver' = '"+Constants.ORACLE_DRIVER+"'" +
                ")");
        //创建Doris目标表
        tEnv.executeSql("CREATE TABLE T_ODS_ZXYH_CRM_BLOCKLIST (\n" +
                "    ETL_DATE DATE,\n" +
                "    ID VARCHAR(96),\n" +
                "    TYPE VARCHAR(6),\n" +
                "    CONTEXT VARCHAR(12000),\n" +
                ...
                " 'table.identifier' = '" + Constants.ODS_DB + ".T_ODS_ZXYH_CRM_BLOCKLIST',\n" +
        ...
        String extractSql = "INSERT INTO T_ODS_ZXYH_CRM_BLOCKLIST(" +
                "ETL_DATE,\n" +
                "ID,\n" +
                "TYPE,\n" +
                "CONTEXT,\n" +
