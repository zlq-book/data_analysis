 ...
 * @date 2025/7/2 9:31
 */
public class ExtractTOdsZxyhRigExperienceRule {
    public static void main(String[] args) throws IOException {
        ...
        //checkpoint设置
        CheckpointUtils.setCheckpoint(env, "ExtractTOdsZxyhRigExperienceRule");
...
//创建上游数据源表
        tEnv.executeSql("CREATE TABLE RIG_EXPERIENCE_RULE (\n" +
                "ID VARCHAR(96) ,\n" +
                ...
                "    'table-name' = '"+Constants.ZXYH_SCHEMA+".RIG_EXPERIENCE_RULE', \n" +
                "    'username' = '"+Constants.ZXYH_USER+"',\n" +
                "    'password' = '"+Constants.ZXYH_PWD+"'\n" +
                ",\n" + "  'driver' = '"+Constants.ORACLE_DRIVER+"'" +
                ")");
        //创建Doris目标表
        tEnv.executeSql("CREATE TABLE T_ODS_ZXYH_RIG_EXPERIENCE_RULE (\n" +
                "    ETL_DATE DATE,\n" +
                "ID VARCHAR(96) ,\n" +
                "RULE_NAME VARCHAR(96) ,\n" +
                "RULE_TYPE CHAR(10) ,\n" +
                ...
                " 'table.identifier' = '" + Constants.ODS_DB + ".T_ODS_ZXYH_RIG_EXPERIENCE_RULE',\n" +
        ...
        String extractSql = "INSERT INTO T_ODS_ZXYH_RIG_EXPERIENCE_RULE(" +
                "ETL_DATE,\n" +
                "ID,\n" +
                "RULE_NAME,\n" +
                "RULE_TYPE,\n" +
