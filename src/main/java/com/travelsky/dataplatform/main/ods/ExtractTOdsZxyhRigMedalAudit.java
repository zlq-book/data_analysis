 ...
 * @date 2025/7/2 9:31
 */
public class ExtractTOdsZxyhRigMedalAudit {
    public static void main(String[] args) throws IOException {
        ...
        //checkpoint设置
        CheckpointUtils.setCheckpoint(env, "ExtractTOdsZxyhRigMedalAudit");
...
//创建上游数据源表
        tEnv.executeSql("CREATE TABLE RIG_MEDAL_AUDIT (\n" +
                "ID VARCHAR(96) ,\n" +
                "MEDAL_ID VARCHAR(96) ,\n" +
                ...
                "    'table-name' = '"+Constants.ZXYH_SCHEMA+".RIG_MEDAL_AUDIT', \n" +
                "    'username' = '"+Constants.ZXYH_USER+"',\n" +
                "    'password' = '"+Constants.ZXYH_PWD+"'\n" +
                ",\n" + "  'driver' = '"+Constants.ORACLE_DRIVER+"'" +
                ")");
        //创建Doris目标表
        tEnv.executeSql("CREATE TABLE T_ODS_ZXYH_RIG_MEDAL_AUDIT (\n" +
                "    ETL_DATE DATE,\n" +
                "ID VARCHAR(96) ,\n" +
                "MEDAL_ID VARCHAR(96) ,\n" +
                "CUSTOMER_ID VARCHAR(600) ,\n" +
                ...
                " 'table.identifier' = '" + Constants.ODS_DB + ".T_ODS_ZXYH_RIG_MEDAL_AUDIT',\n" +
        ...
        String extractSql = "INSERT INTO T_ODS_ZXYH_RIG_MEDAL_AUDIT(" +
                "ETL_DATE,\n" +
                "ID,\n" +
                "MEDAL_ID,\n" +
                "CUSTOMER_ID,\n" +
