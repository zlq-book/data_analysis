 ...
 * 2024年1月1号~1年前数据
 */
public class ExtractTOdsLygjDepartPassengerInfoHistory {
    public static void main(String[] args) throws IOException {
        ...
        //checkpoint设置
        CheckpointUtils.setCheckpoint(env, "ExtractTOdsLygjDepartPassengerInfoHistory");
        ...
        tEnv.executeSql("CREATE TABLE DEPART_PASSENGER_INFO_HISTORY (\n" +
                ...
                "    'table-name' = '" + Constants.LYGJ_SCHEMA + ".DEPART_PASSENGER_INFO_HISTORY',\n" +
        ...
        String extractSql = "INSERT INTO T_ODS_LYGJ_DEPART_PASSENGER_INFO(" +
                ...
                "sm4_encrypt(aes_decrypt(ET, '" + Constants.LYGJ_AES_KEY + "'), '" + Constants.SM4_KEY + "') AS ET,\n" +
                "ET_NUM,\n" +
                "sm4_encrypt(aes_decrypt(ET_ID_NUM, '" + Constants.LYGJ_AES_KEY + "'), '" + Constants.SM4_KEY + "') AS ET_ID_NUM,\n" +
                "sm4_encrypt(aes_decrypt(ID_NUM, '" + Constants.LYGJ_AES_KEY + "'), '" + Constants.SM4_KEY + "') AS ID_NUM,\n" +
                "IS_VIP,\n" +
                "IS_CIP,\n" +
                "IS_BLND,\n" +
                "IS_BSCT,\n" +
                ...
                "EDIWARN,\n" +
                "EDIMARK,\n" +
                "sm4_encrypt(aes_decrypt(RELATION, '" + Constants.LYGJ_AES_KEY + "'), '" + Constants.SM4_KEY + "') AS RELATION,\n" +
                "BAGTAG,\n" +
                "FILE_NAME,\n" +
                "ORIG_CNNAME,\n" +
                "IN_FLT_NUM,\n" +
                ...
                "STAR_FFP_NO,\n" +
                "LAST_FQTV_LEVEL,\n" +
                "sm4_encrypt(aes_decrypt(TEL_NUM, '" + Constants.LYGJ_AES_KEY + "'), '" + Constants.SM4_KEY + "') AS TEL_NUM,\n" +
                "SUID,\n" +
                "FQTV_DETAIL_LEVEL,\n" +
                "MDM_GENDER,\n" +
                "sm4_encrypt(aes_decrypt(CERT_NO, '" + Constants.LYGJ_AES_KEY + "'), '" + Constants.SM4_KEY + "') AS CERT_NO,\n" +
                "SPECIAL_SERVICE,\n" +
                "SPECIAL_TAG,\n" +
                "IS_VVIP,\n" +
                "IS_CHILD,\n" +
                ...
                "ACTION_CODE,\n" +
                "ID_TYPE,\n" +
                "sm4_encrypt(aes_decrypt(ID_INFO, '" + Constants.LYGJ_AES_KEY + "'), '" + Constants.SM4_KEY + "') AS ID_INFO,\n" +
                "MC_FLT,\n" +
                "PRE_SEG,\n" +
                "NEXT_SEG,\n" +
                "IO_FLAG,\n" +
                ...
                //+ " WHERE  CREATE_TIME BETWEEN TIMESTAMP '2024-01-01 00:00:00' AND TIMESTAMP '2025-08-08 23:59:59.999' " +
                //" OR  UPDATE_TIME BETWEEN TIMESTAMP '2024-01-01 00:00:00' AND TIMESTAMP '2025-08-08 23:59:59.999' "
