...
public class ExtractTOdsZsfOdrOrderDetailSecondaryDouyin {
    public static void main(String[] args) throws IOException {
        ...
        //checkpoint设置
        CheckpointUtils.setCheckpoint(env, "ExtractTOdsZsfOdrOrderDetailSecondaryDouyin");
        ...
        //创建上游ORACLE数据源表
        tEnv.executeSql("CREATE TABLE ODR_ORDER_DETAIL_SECONDARY_DOUYIN (\n" +
                ...
                "    REMARK VARCHAR(765),\n" +
                "    INTERNATIONAL_FLAG VARCHAR(96),\n" +
                "    CERT_TYPE VARCHAR(15),\n" +
                "    CERT_NO VARCHAR(96),\n" +
                "    CN_FIRST_NAME VARCHAR(384),\n" +
                "    CN_LAST_NAME VARCHAR(384),\n" +
                "    EN_FIRST_NAME VARCHAR(384),\n" +
                "    EN_LAST_NAME VARCHAR(384),\n" +
                ...
                "    'table-name' = 'ODR_ORDER_DETAIL_SECONDARY_DOUYIN', \n" +
        ...
        String ZSF_ODR_ORDER_DETAIL_SECONDARY_DOUYIN = "CREATE TABLE T_ODS_ZSF_ODR_ORDER_DETAIL_SECONDARY_DOUYIN (\n" +
...
//                ")";
                ...
                " 'table.identifier' = '" + Constants.ODS_DB + ".T_ODS_ZSF_ODR_ORDER_DETAIL_SECONDARY_DOUYIN',\n" +
                ...
                "    'password' = '" + Constants.ODS_PWD + "'\n" +
                ")";
        tEnv.executeSql(ZSF_ODR_ORDER_DETAIL_SECONDARY_DOUYIN);

        String extractSql = "INSERT INTO T_ODS_ZSF_ODR_ORDER_DETAIL_SECONDARY_DOUYIN(" +
                "ETL_DATE\n" +
                ",ID\n" +
                ",ORDER_PACKAGE_ID\n" +
                ",ORDER_DETAIL_ID\n" +
                ...
                ",UPDATE_TIME\n" +
                ",UPDATE_USER" +
                " FROM ODR_ORDER_DETAIL_SECONDARY_DOUYIN "
