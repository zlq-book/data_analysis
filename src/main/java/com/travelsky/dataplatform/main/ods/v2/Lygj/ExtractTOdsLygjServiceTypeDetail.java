 ...
 */
public class ExtractTOdsLygjServiceTypeDetail {
    public static void main(String[] args) throws IOException {
        ...
        //checkpoint设置
        CheckpointUtils.setCheckpoint(env, "ExtractTOdsLygjServiceTypeDetail");
        ...
        //创建上游ORACLE数据源表
        tEnv.executeSql("CREATE TABLE SERVICE_TYPE_DETAIL (\n" +
                "    ID  BIGINT,\n" +
                ...
                "    'table-name' = '" + Constants.LYGJ_SCHEMA + ".SERVICE_TYPE_DETAIL', \n" +
                "    'username' = '" + Constants.LYGJ_USER + "',\n" +
                "    'password' = '" + Constants.LYGJ_PWD + "'\n" + ",\n" +
                "    'driver' = '" + Constants.ORACLE_DRIVER + "'" +
                ")");
        //创建Doris目标表
        tEnv.executeSql("CREATE TABLE T_ODS_LYGJ_SERVICE_TYPE_DETAIL (\n" +
                "    ID  BIGINT,\n" +
                "    SERVICE_TYPE_ID  BIGINT,\n" +
                "    NAME            varchar(300),\n" +
                "    VALID           BIGINT,\n" +
                ...
                //"    'table-name' = 'T_ODS_LYGJ_SERVICE_TYPE_DETAIL',\n" +
                ...
                " 'table.identifier' = '" + Constants.ODS_DB + ".T_ODS_LYGJ_SERVICE_TYPE_DETAIL',\n" +
                ...
                "    'password' = '" + Constants.ODS_PWD + "'\n" +
                ")");
        String extractSql = "INSERT INTO T_ODS_LYGJ_SERVICE_TYPE_DETAIL (" +
                "    ETL_DATE,\n" +
                "    ID,\n" +
                "    SERVICE_TYPE_ID,\n" +
                "    NAME,\n" +
