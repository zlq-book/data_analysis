 ...
 * @date 2025/7/2 9:31
 */
public class ExtractTOdsZxyhCrmInvoiceInfo {
    public static void main(String[] args) throws IOException {
        ...
        //checkpoint设置
        CheckpointUtils.setCheckpoint(env, "ExtractTOdsZxyhCrmInvoiceInfo");
...
//创建上游数据源表
        tEnv.executeSql("CREATE TABLE CRM_INVOICE_INFO (\n" +
                "ID VARCHAR(96) ,\n" +
                "CUSTOMER_ID VARCHAR(600) ,\n" +
                "LETTER_HEAD VARCHAR(600) ,\n" +
                "TIN VARCHAR(150) ,\n" +
                "PHONE VARCHAR(150) ,\n" +
                "EMAIL VARCHAR(600) ,\n" +
                "INVOICE_TYPE VARCHAR(3) ,\n" +
                "COMP_ADDRESS VARCHAR(1500) ,\n" +
                "COMP_BANK VARCHAR(1500) ,\n" +
                "AC_BANK VARCHAR(1500) ,\n" +
                "STATUS VARCHAR(1500) ,\n" +
                ...
                "    'table-name' = '"+Constants.ZXYH_SCHEMA+".CRM_INVOICE_INFO', \n" +
                "    'username' = '"+Constants.ZXYH_USER+"',\n" +
                "    'password' = '"+Constants.ZXYH_PWD+"'\n" +
                ",\n" + "  'driver' = '"+Constants.ORACLE_DRIVER+"'" +
                ")");
        //创建Doris目标表
        tEnv.executeSql("CREATE TABLE T_ODS_ZXYH_CRM_INVOICE_INFO (\n" +
                "    ETL_DATE DATE,\n" +
                "ID VARCHAR(96) ,\n" +
                "CUSTOMER_ID VARCHAR(600) ,\n" +
                "LETTER_HEAD VARCHAR(600) ,\n" +
                ...
                " 'table.identifier' = '" + Constants.ODS_DB + ".T_ODS_ZXYH_CRM_INVOICE_INFO',\n" +
        ...
        String extractSql = "INSERT INTO T_ODS_ZXYH_CRM_INVOICE_INFO(" +
                "ETL_DATE,\n" +
                "ID,\n" +
                "CUSTOMER_ID,\n" +
                "LETTER_HEAD,\n" +
                ...
                "COMP_ADDRESS,\n" +
                "COMP_BANK,\n" +
                "  sm4_encrypt(aes_decrypt(AC_BANK, '" + Constants.ZXYH_AES_KEY + "'), '" + sm4key + "') AC_BANK,\n" +
                "STATUS,\n" +
                "COMMENTS,\n" +
                "ENABLE,\n" +
                "CREATE_TIME,\n" +
