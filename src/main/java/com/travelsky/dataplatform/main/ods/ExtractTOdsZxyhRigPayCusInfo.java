 ...
 * @date 2025/7/2 9:31
 */
public class ExtractTOdsZxyhRigPayCusInfo {
    public static void main(String[] args) throws IOException {
        ...
        //checkpoint设置
        CheckpointUtils.setCheckpoint(env, "ExtractTOdsZxyhRigPayCusInfo");
...
//创建上游数据源表
        tEnv.executeSql("CREATE TABLE RIG_PAY_CUS_INFO (\n" +
                "ID VARCHAR(96) ,\n" +
                "CUS_ID VARCHAR(96) ,\n" +
                "LEVEL_ID VARCHAR(96) ,\n" +
                "BEGIN_DATE TIMESTAMP(6) ,\n" +
                "EXPIRATION_DATE TIMESTAMP(6) ,\n" +
                "EXPIRATION_STATUS CHAR(1) ,\n" +
                "ENABLE CHAR(1) ,\n" +
                ...
                "    'table-name' = '"+Constants.ZXYH_SCHEMA+".RIG_PAY_CUS_INFO', \n" +
                "    'username' = '"+Constants.ZXYH_USER+"',\n" +
                "    'password' = '"+Constants.ZXYH_PWD+"'\n" +
                ",\n" + "  'driver' = '"+Constants.ORACLE_DRIVER+"'" +
                ")");
        //创建Doris目标表
        tEnv.executeSql("CREATE TABLE T_ODS_ZXYH_RIG_PAY_CUS_INFO (\n" +
                "    ETL_DATE DATE,\n" +
                "ID VARCHAR(96) ,\n" +
                "CUS_ID VARCHAR(96) ,\n" +
                "LEVEL_ID VARCHAR(96) ,\n" +
                ...
                " 'table.identifier' = '" + Constants.ODS_DB + ".T_ODS_ZXYH_RIG_PAY_CUS_INFO',\n" +
        ...
        String extractSql = "INSERT INTO T_ODS_ZXYH_RIG_PAY_CUS_INFO(" +
                "ETL_DATE,\n" +
                "ID,\n" +
                "CUS_ID,\n" +
                "LEVEL_ID,\n" +
