...
public class SaxXmlTOdsClkAccuint extends DefaultHandler {
    static final Logger logger = LoggerFactory.getLogger(SaxXmlTOdsClkAccuint.class);
    ...
    public SaxXmlTOdsClkAccuint(String etlDate) {
