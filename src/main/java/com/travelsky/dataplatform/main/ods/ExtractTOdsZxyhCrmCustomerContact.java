 ...
 * @date 2025/7/2 9:31
 */
public class ExtractTOdsZxyhCrmCustomerContact {
    public static void main(String[] args) throws IOException {
        ...
        //checkpoint设置
        CheckpointUtils.setCheckpoint(env, "ExtractTOdsZxyhCrmCustomerContact");
...
//创建上游数据源表
        tEnv.executeSql("CREATE TABLE CRM_CUSTOMER_CONTACT (\n" +
                "ID VARCHAR(96) ,\n" +
                ...
                "    'table-name' = '"+Constants.ZXYH_SCHEMA+".CRM_CUSTOMER_CONTACT', \n" +
                "    'username' = '"+Constants.ZXYH_USER+"',\n" +
                "    'password' = '"+Constants.ZXYH_PWD+"'\n" +
                ",\n" + "  'driver' = '"+Constants.ORACLE_DRIVER+"'" +
                ")");
        //创建Doris目标表
        tEnv.executeSql("CREATE TABLE T_ODS_ZXYH_CRM_CUSTOMER_CONTACT (\n" +
                "    ETL_DATE DATE,\n" +
                "ID VARCHAR(96) ,\n" +
                "CUSTOMER_ID VARCHAR(600) ,\n" +
                "REAL_NAME_FLAG CHAR(1) ,\n" +
                ...
                " 'table.identifier' = '" + Constants.ODS_DB + ".T_ODS_ZXYH_CRM_CUSTOMER_CONTACT',\n" +
        ...
        String extractSql = "INSERT INTO T_ODS_ZXYH_CRM_CUSTOMER_CONTACT(" +
                "ETL_DATE,\n" +
                "ID,\n" +
                "CUSTOMER_ID,\n" +
                "REAL_NAME_FLAG,\n" +
