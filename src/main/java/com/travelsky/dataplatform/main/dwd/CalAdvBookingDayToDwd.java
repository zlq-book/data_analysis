...
import com.travelsky.trp.usercenter.data.analysis.transform.labels.TickingTicDataStream;
 ...
 * @date 2025/7/2 9:31
 */
public class CalAdvBookingDayToDwd {
...
//        String etlDate = "2025-04-30";
        ...
        */
        ...
        // 提前出票天数
        TickingTicDataStream.result(tEnv, etlDate);
