...
/**
 * 达标人群（报名） 实体类
 * 用于读取和写入达标人群报名Excel文件
 */
public class TOdsClkQualifiedRegistration implements Serializable {
    ...
    public TOdsClkQualifiedRegistration() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof TOdsClkQualifiedRegistration)) return false;
        final TOdsClkQualifiedRegistration other = (TOdsClkQualifiedRegistration) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof TOdsClkQualifiedRegistration;
    }
    ...
    public String toString() {
        return "TOdsClkQualifiedRegistration(id=" + this.getId() + ", activityChineseName=" + this.getActivityChineseName() + ", memberCardNumber=" + this.getMemberCardNumber() + ", etlCreateTime=" + this.getEtlCreateTime() + ", etlUpdateTime=" + this.getEtlUpdateTime() + ", etlDate=" + this.getEtlDate() + ")";
    }
}