...
/**
 * SC_优惠券销售报表明细 实体类
 * 用于读取和写入优惠券销售报表Excel文件
 */
public class TOdsScCouponSaleDetail {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof TOdsScCouponSaleDetail)) return false;
        final TOdsScCouponSaleDetail other = (TOdsScCouponSaleDetail) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof TOdsScCouponSaleDetail;
    }
    ...
    public String toString() {
        return "TOdsScCouponSaleDetail(id=" + this.getId() + ", orderNumber=" + this.getOrderNumber() + ", bankOrderNumber=" + this.getBankOrderNumber() + ", bankName=" + this.getBankName() + ", channel=" + this.getChannel() + ", contactName=" + this.getContactName() + ", contactPhoneNumber=" + this.getContactPhoneNumber() + ", orderDate=" + this.getOrderDate() + ", orderStatus=" + this.getOrderStatus() + ", voucherCode=" + this.getVoucherCode() + ", voucherName=" + this.getVoucherName() + ", voucherAmount=" + this.getVoucherAmount() + ", paymentAmount=" + this.getPaymentAmount() + ", paymentDate=" + this.getPaymentDate() + ", paymentStatus=" + this.getPaymentStatus() + ", username=" + this.getUsername() + ", etlCreateTime=" + this.getEtlCreateTime() + ", etlUpdateTime=" + this.getEtlUpdateTime() + ", etlDate=" + this.getEtlDate() + ")";
    }
}