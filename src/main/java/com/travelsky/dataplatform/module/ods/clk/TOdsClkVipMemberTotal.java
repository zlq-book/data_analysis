...
/**
 * 国航系贵宾会员总量 实体类
 * 用于读取和写入国航系贵宾会员总量报表Excel文件
 */
public class TOdsClkVipMemberTotal implements java.io.Serializable {
     ...
     */
    @ExcelProperty("各属性总量")
    private BigDecimal totalByAttributes;
    ...
    public BigDecimal getTotalByAttributes() {
        return this.totalByAttributes;
    }
    ...
    public void setTotalByAttributes(BigDecimal totalByAttributes) {
        this.totalByAttributes = totalByAttributes;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof TOdsClkVipMemberTotal)) return false;
        final TOdsClkVipMemberTotal other = (TOdsClkVipMemberTotal) o;
        ...
        final Object this$totalByAttributes = this.getTotalByAttributes();
        final Object other$totalByAttributes = other.getTotalByAttributes();
        if (this$totalByAttributes == null ? other$totalByAttributes != null : !this$totalByAttributes.equals(other$totalByAttributes))
            return false;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof TOdsClkVipMemberTotal;
    }
    ...
    public int hashCode() {
        ...
        final Object $totalByAttributes = this.getTotalByAttributes();
        result = result * PRIME + ($totalByAttributes == null ? 43 : $totalByAttributes.hashCode());
    ...
    public String toString() {
        return "TOdsClkVipMemberTotal(id=" + this.getId() + ", date=" + this.getDate() + ", name=" + this.getName() + ", finalWhite=" + this.getFinalWhite() + ", platinum=" + this.getPlatinum() + ", gold=" + this.getGold() + ", silver=" + this.getSilver() + ", totalByAttributes=" + this.getTotalByAttributes() + ", etlCreateTime=" + this.getEtlCreateTime() + ", etlUpdateTime=" + this.getEtlUpdateTime() + ", etlDate=" + this.getEtlDate() + ")";
    }
}