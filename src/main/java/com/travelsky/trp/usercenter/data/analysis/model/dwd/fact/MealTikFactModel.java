...
/**
 * 附加服务选餐出票航段事实表实体类-T_DWD_MEAL_TIK_FACT
 * @author yuzc
 * @date 2025/7/30
 */
public class MealTikFactModel {
    /**
     * pk_id
     */
    @JsonProperty("PK_ID")
     ...
     * EMD出票日期
     */
    @JsonProperty("FK_MEALTIK_DATE")
    private String fkMealtikDate;

    /**
     * EMD出票时间
     */
    @JsonProperty("FK_MEALTIK_TIME")
    private String fkMealtikTime;
     ...
     * 选餐详情
     */
    @JsonProperty("MEAL_DEATAIL")
    private String mealDeatail;
    ...
    public String getFkMealtikDate() {
        return fkMealtikDate;
    }

    public void setFkMealtikDate(String fkMealtikDate) {
        this.fkMealtikDate = fkMealtikDate;
    }

    public String getFkMealtikTime() {
        return fkMealtikTime;
    }

    public void setFkMealtikTime(String fkMealtikTime) {
        this.fkMealtikTime = fkMealtikTime;
    }
    ...
    public String getMealDeatail() {
        return mealDeatail;
    }

    public void setMealDeatail(String mealDeatail) {
        this.mealDeatail = mealDeatail;
    }
    ...
    public String toString() {
        return "MealTikFactModel{" +
                "pkId='" + pkId + '\'' +
                ", fkMealtikDate='" + fkMealtikDate + '\'' +
                ", fkMealtikTime='" + fkMealtikTime + '\'' +
