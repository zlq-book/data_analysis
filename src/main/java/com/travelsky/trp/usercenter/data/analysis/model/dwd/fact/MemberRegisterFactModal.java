...
public class MemberRegisterFactModal {
    ...
    private String devChannelTwo; // 二级发展渠道ID
    ...
    // 常旅客系统航班日期
    @JsonProperty("MEMBER_REGIST_FLT_DATE")
    private String memberRegistFltDate;

    // 是否为高价值发展会员
    @JsonProperty("IS_HIGH_VALUE_DEVELOPER")
    private Boolean isHighValueDeveloper;
    ...
    public String getMemberRegistFltDate() {
        return memberRegistFltDate;
    }

    public void setMemberRegistFltDate(String memberRegistFltDate) {
        this.memberRegistFltDate = memberRegistFltDate;
    }

    public Boolean getHighValueDeveloper() {
        return isHighValueDeveloper;
    }

    public void setHighValueDeveloper(Boolean highValueDeveloper) {
        isHighValueDeveloper = highValueDeveloper;
    }

    @Override
    public String toString() {
        return "MemberRegisterFactModal{" +
                "pkId='" + pkId + '\'' +
                ", fkTid='" + fkTid + '\'' +
                ...
                ", memberRegistFltDate='" + memberRegistFltDate + '\'' +
                ", isHighValueDeveloper=" + isHighValueDeveloper +
