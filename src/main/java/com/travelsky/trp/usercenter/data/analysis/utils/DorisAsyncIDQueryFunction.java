 ...
 * @date 2025/8/4  15:48
 */
public class DorisAsyncIDQueryFunction extends RichAsyncFunction<BookingSegFactModel, BookingSegFactModel> {
    private static final Logger logger = LoggerFactory.getLogger(DorisAsyncIDQueryFunction.class);
    ...
    private void mergeModels(BookingSegFactModel oldModel, BookingSegFactModel newModel) {
        try {
            ...
            String documentType = newModel.getCertType();
            String documentNumber = newModel.getCertNumber();
            Integer age = newModel.getPassengerAge();
            String setFkPassengerUserTid = newModel.getFkPassengerUserTid();
            ...
            newModel.setCertType(documentType);
            newModel.setCertNumber(documentNumber);
            newModel.setPassengerAge(age);
            newModel.setFkPassengerUserTid(setFkPassengerUserTid);
